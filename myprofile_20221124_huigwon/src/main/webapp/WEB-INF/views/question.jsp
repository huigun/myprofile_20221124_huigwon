				...
				<table width="70%" border="0" cellspacing="0" cellpadding="10" class="contentbox2">
					<tr class="contentbox">				
						...
						<table border="0" cellspacing="0" cellpadding="10">
							<form action="questionok" method="post" name="board_form">
								<tr>
									<td><span class="content_text01">ID</span></td>
									<td><input class="input_type01" type="text" name="qid" readonly="readonly" value="${mid }"></td>
								</tr>
								<tr>
									<td><span class="content_text01">NAME</span></td>
									<td><input class="input_type01" type="text" name="qname" readonly="readonly" value="${mname }"></td>
								</tr>
								<tr>
									<td><span class="content_text01">TITLE</span></td>	
									<td><input class="textarea_type02" type="text" name="qtitle"></td>
								</tr>
								<tr>
									<td><span class="content_text01">QUESTION</span></td>	
									<td><textarea class="textarea_type01" name="qcontent"></textarea></td>
								</tr>
								<tr>
									<td><span class="content_text01">E-MAIL</span></td>
									<td><input class="input_type01" type="text" name="qemail" readonly="readonly" value="${memail }"></td>
								</tr>
								<tr align="center">
									<td colspan="2">
